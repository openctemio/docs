...
*🌙 Dark mode:* ![Dashboard / Tổng quan — dark](screenshots/home-dark.png)
...
*🌙 Dark mode:* ![Executive Summary — dark](screenshots/insights__executive-dark.png)
...
*🌙 Dark mode:* ![CTEM maturity — dark](screenshots/insights__ctem-maturity-dark.png)
...
*🌙 Dark mode:* ![Notifications — dark](screenshots/notifications-dark.png)
...
*🌙 Dark mode:* ![Security Reports — dark](screenshots/reports-dark.png)
...
*🌙 Dark mode:* ![Account Settings — Profile — dark](screenshots/account-dark.png)
...
*🌙 Dark mode:* ![Account Settings — Security — dark](screenshots/account__security-dark.png)
...
*🌙 Dark mode:* ![Account Settings — Activity — dark](screenshots/account__activity-dark.png)
